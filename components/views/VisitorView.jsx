                            ...
                            <div className="space-y-20">
                                <div className="grid lg:grid-cols-2 gap-16 items-center">
                                    <div className="space-y-6">
                                        <h2 className="font-h1 text-slate-900 uppercase">Connecting you to the world of Halal.</h2>
                                    ...
                                    <Card className="bg-slate-900 text-white p-12 rounded-[40px] shadow-2xl relative overflow-hidden">
                                        ...
                                        <h3 className="font-h3 mb-6 text-white uppercase">Admission is Free for Trade Visitors</h3>
                                ...
                                <div className="space-y-10">
                                    <h2 className="font-h2 text-center text-slate-900 uppercase">Experience the Full Spectrum</h2>
                                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                                        {whyVisitData.map((reason, i) => (
                                            <div key={i} className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:shadow-xl transition-all group">
                                                ...
                                                <h3 className="font-h4 text-slate-900 mb-4 uppercase">{reason.title}</h3>
                        ...
                        {subView === 'who-should' && (
                            <div className="space-y-12">
                                <div className="text-center max-w-3xl mx-auto mb-16">
                                    <h2 className="font-h2 text-slate-900 mb-4 uppercase">Target Visitor Groups</h2>
                                ...
                                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                                    {visitorCategories.map((cat, i) => (
                                        <Card key={i} className="p-10 hover:border-orange-500/30 transition-all border-slate-200">
                                            <h3 className="font-label text-slate-900 mb-8 flex items-center justify-between border-b border-slate-100 pb-4">
                        ...
                        {subView === 'admission' && (
                            <div className="grid lg:grid-cols-5 gap-8">
                                <Card className="lg:col-span-2 p-10 bg-slate-900 text-white border-none rounded-[40px] shadow-2xl relative overflow-hidden group">
                                    ...
                                    <h3 className="font-h2 mb-10 text-white uppercase">Exhibition Hours</h3>
                                    <div className="space-y-10">
                                ...
                                <div className="lg:col-span-3 space-y-6">
                                    <Card className="p-10 rounded-[40px] border-slate-200 shadow-sm">
                                        ...
                                        <h3 className="font-h2 text-slate-900 mb-4 uppercase">Venue Location</h3>
                                        <p className="font-h4 text-slate-900 mb-2 uppercase">MITEC, Kuala Lumpur</p>
                                        <p className="font-body-sm text-slate-500 mb-10 uppercase">8 Jalan Dutamas 2, Kompleks Kerajaan, 50480 Kuala Lumpur, Wilayah Persekutuan Kuala Lumpur</p>
                                    ...
                                    <Card className="p-8 bg-orange-50 border-orange-100 rounded-[32px] flex items-center gap-6">
                                        ...
                                        <div>
                                            <h4 className="font-h4 text-slate-900 mb-1 uppercase">Important Note</h4>

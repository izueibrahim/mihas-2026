                ...
                <div className="p-6 md:p-8 overflow-y-auto">
                    {isSponsor && (
                        <p className="text-sm text-slate-600 mb-6 border-b border-slate-100 pb-6">
                            MIHAS 2026 provides a unique platform for your brand to communicate the brand story and gain access to new markets. As the world's largest Halal B2B trade show, the association with MIHAS 2026 will elevate your brand profile to a global level.
                        </p>
                    )}
